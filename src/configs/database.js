...
db.serialize(() => {
    db.run('CREATE TABLE IF NOT EXISTS users(id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL, email TEXT NOT NULL, dateOfBirth DATE, password TEXT NOT NULL, profileId INTEGER NOT NULL, FOREIGN KEY(profileId) REFERENCES profiles(id))');
    ...
    db.run('CREATE TABLE IF NOT EXISTS games(id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL, gender TEXT NOT NULL, platformId INTEGER NOT NULL, FOREIGN KEY(platformId) REFERENCES platforms(id))');
